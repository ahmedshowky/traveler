...
jQuery(function($) {
    ...
    $(document).on('change', '#nav-tp_flight .passengers-class input[name=adults]', function() {
        if ($(this).val() == '') {
            //$(this).val(1)
        } else {
    ...
    $(document).on('change', '#nav-tp_flight .passengers-class input[name=children]', function() {
        if ($(this).val() == '') {
            //$(this).val(0)
        } else {
            var infants = $('.passengers-class input[name=infants]').val();
    ...
    $(document).on('change', '#nav-tp_flight .passengers-class input[name=infants]', function() {
        if ($(this).val() == '') {
            //$(this).val(0)
        } else {
            var adults = $('.passengers-class input[name=adults]').val();
    ...
    $(document).on('focusout', '#nav-tp_flight .passengers-class input[name=adults]', function() {
        if ($(this).val() == '' || $(this).val() == 0) {
            $(this).val(1)
        }
    });
    $(document).on('focusout', '#nav-tp_flight .passengers-class input[name=children], #nav-tp_flight .passengers-class input[name=infants]', function() {
        if ($(this).val() == '') {
            $(this).val(0)
        }
    });
