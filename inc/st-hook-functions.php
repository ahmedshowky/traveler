...
if(!function_exists('st_notice_enqueue_css_js')){
    function st_notice_enqueue_css_js(){
        ...
        //Notice new demo
        $pointer_name_demo = 'install-new-6-demo';
        
		if ( false === array_search( $pointer_name_demo, $dismissed, true ) ) {
			$content_demo  = '';
			$content_demo .= '<h3>' . __( 'New Update!', 'traveler' ) . '</h3>';
			$content_demo .= '<p>' . __( 'Having 1 new layout demo : <strong>Resort Spa Hotel</strong>  <a target="__blank" href="https://travelerwp.com/new-version-3-0-8-new-updated-demos-for-hotels-and-resorts-business/?utm_source=themeforest&utm_medium=banner&utm_campaign=post308fromthemeforest">Check Now</a> build by elementor .', 'traveler' ) . '</p>';
